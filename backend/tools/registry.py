...
TOOL_ALLOWLIST: dict[AgentRole, frozenset[str]] = {
    ...
    AgentRole.AR_COLLECTIONS: _SHARED | {"rank_collection_opportunities", "get_ar_aging_summary"},
    AgentRole.AP_OPTIMIZATION: _SHARED | {"rank_deferral_candidates"},
    AgentRole.SUPPLIER_RISK: _SHARED | {"get_supplier_risk_profile", "rank_deferral_candidates"},
    ...
    AgentRole.STRESS_TEST: _SHARED | {"get_forecast_error_percentiles", "get_forecast_summary"},
